...
class Attendance:
    ...
    def __init__(self,root):
        ...
        # backgorund image 
        bg1=Image.open(r"D:\program\python language\Smart-Ai-Attendance-system\Images_GUI\bg2.jpg")
        ...
        #title section
        title_lb1 = Label(bg_img,text="Welcome to Attendance Panel",font=("verdana",30,"bold"),bg="white",fg="#ff006d")
        ...
        #Student id
        studentId_label = Label(left_frame,text="Std-ID:",font=("verdana",12,"bold"),fg="#ff006d",bg="white")
        ...
        #Student Roll
        student_roll_label = Label(left_frame,text="Roll.No:",font=("verdana",12,"bold"),fg="#ff006d",bg="white")
        ...
        #Studnet Name
        student_name_label = Label(left_frame,text="Std-Name:",font=("verdana",12,"bold"),fg="#ff006d",bg="white")
        ...
        #Department
        # dep_label = Label(left_frame,text="Department:",font=("verdana",12,"bold"),fg="#ff006d",bg="white")
        ...
        #time
        time_label = Label(left_frame,text="Time:",font=("verdana",12,"bold"),fg="#ff006d",bg="white")
        ...
        #Date 
        date_label = Label(left_frame,text="Date:",font=("verdana",12,"bold"),fg="#ff006d",bg="white")
        ...
        #Attendance
        student_attend_label = Label(left_frame,text="Attend-status:",font=("verdana",12,"bold"),fg="#ff006d",bg="white")
        ...
        #Improt button
        save_btn=Button(btn_frame,command=self.importCsv,text="Import CSV",width=12,font=("verdana",12,"bold"),fg="white",bg="#ff006d")
        save_btn.grid(row=0,column=0,padx=6,pady=10,sticky=W)

        #Exprot button
        update_btn=Button(btn_frame,command=self.exportCsv,text="Export CSV",width=12,font=("verdana",12,"bold"),fg="white",bg="#ff006d")
        update_btn.grid(row=0,column=1,padx=6,pady=8,sticky=W)

        #Update button
        del_btn=Button(btn_frame,command=self.action,text="Update",width=12,font=("verdana",12,"bold"),fg="white",bg="#ff006d")
        del_btn.grid(row=0,column=2,padx=6,pady=10,sticky=W)

        #reset button
        reset_btn=Button(btn_frame,command=self.reset_data,text="Reset",width=12,font=("verdana",12,"bold"),fg="white",bg="#ff006d")
    ...
    #Update button
        del_btn=Button(right_frame,command=self.update_data,text="Update",width=12,font=("verdana",12,"bold"),fg="white",bg="#ff006d")
        del_btn.grid(row=0,column=1,padx=6,pady=10,sticky=W)
    #Update button
        del_btn=Button(right_frame,command=self.delete_data,text="Delete",width=12,font=("verdana",12,"bold"),fg="white",bg="#ff006d")
        del_btn.grid(row=0,column=2,padx=6,pady=10,sticky=W)
