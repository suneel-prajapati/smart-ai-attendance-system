...
class Face_Recognition:
    ...
    def __init__(self,root):
        ...
        #title section
        title_lb1 = Label(bg_img,text="Welcome to Face Recognition Pannel",font=("verdana",30,"bold"),bg="white",fg="#ff006d")
        ...
        std_img_btn=Image.open(r"D:\program\python language\Smart-Ai-Attendance-system\Images_GUI\f_det.jpg")
        ...
        std_b1_1 = Button(bg_img,command=self.face_recog,text="Face Detector",cursor="hand2",font=("tahoma",15,"bold"),bg="white",fg="#ff006d")
        std_b1_1.place(x=600,y=350,width=180,height=45)
    #=====================Attendance===================

    def mark_attendance(self,i,r,n):
        with open("D:/program/python language/Smart-Ai-Attendance-system/attendance.csv","w+",newline="\n") as f:
    ...
    def face_recog(self):
        ...
        faceCascade=cv2.CascadeClassifier('D:\program\python language\Smart-Ai-Attendance-system\haarcascade_frontalface_default.xml')
        clf=cv2.face.LBPHFaceRecognizer_create()
        clf.read('D:\program\python language\Smart-Ai-Attendance-system\clf.xml')
