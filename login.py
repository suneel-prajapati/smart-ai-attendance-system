...
class Login:
    def __init__(self,root):
        ...
        self.bg=ImageTk.PhotoImage(file=r"D:\program\python language\Smart-Ai-Attendance-system\Images_GUI\loginBg1.jpg")
        
        lb1_bg=Label(self.root,image=self.bg)
        lb1_bg.place(x=0,y=0, relwidth=1,relheight=1)

        frame1= Frame(self.root,bg="#ff006d")
        frame1.place(x=560,y=170,width=340,height=450)

        img1=Image.open(r"D:\program\python language\Smart-Ai-Attendance-system\Images_GUI\log1.jpg")
        img1=img1.resize((100,100),Image.LANCZOS)
        self.photoimage1=ImageTk.PhotoImage(img1)
        lb1img1 = Label(image=self.photoimage1,bg="#ff006d")
        lb1img1.place(x=690,y=175, width=100,height=100)

        get_str = Label(frame1,text="Login",font=("times new roman",20,"bold"),fg="white",bg="#ff006d")
        get_str.place(x=140,y=100)

        #label1 
        username =lb1= Label(frame1,text="Username:",font=("times new roman",15,"bold"),fg="white",bg="#ff006d")
        ...
        #label2 
        pwd =lb1= Label(frame1,text="Password:",font=("times new roman",15,"bold"),fg="white",bg="#ff006d")
        ...
        loginbtn=Button(frame1,command=self.login,text="Login",font=("times new roman",15,"bold"),bd=0,relief=RIDGE,fg="#ff006d",bg="white",activeforeground="white",activebackground="#ff006d")
        loginbtn.place(x=33,y=320,width=270,height=35)


        # Creating Button Registration
        loginbtn=Button(frame1,command=self.reg,text="Register",font=("times new roman",10,"bold"),bd=0,relief=RIDGE,fg="white",bg="#ff006d",activeforeground="orange",activebackground="#002B53")
        loginbtn.place(x=33,y=370,width=50,height=20)


        # Creating Button Forget
        loginbtn=Button(frame1,command=self.forget_pwd,text="Forget",font=("times new roman",10,"bold"),bd=0,relief=RIDGE,fg="white",bg="#ff006d",activeforeground="orange",activebackground="#002B53")
...
# This part is image labels setting start 
        ...
        # ------------------------------------------------------------------------------------------------------------------- 
        # student button 1
        std_img_btn=Image.open(r"D:\program\python language\Smart-Ai-Attendance-system\Images_GUI\std1.jpg")
        ...
        det_img_btn=Image.open(r"D:\program\python language\Smart-Ai-Attendance-system\Images_GUI\det1.jpg")
        ...
        att_img_btn=Image.open(r"D:\program\python language\Smart-Ai-Attendance-system\Images_GUI\att.jpg")
        ...
        hlp_img_btn=Image.open(r"D:\program\python language\Smart-Ai-Attendance-system\Images_GUI\hlp.jpg")
        ...
        # Start below buttons.........
         # Train   button 5
        tra_img_btn=Image.open(r"D:\program\python language\Smart-Ai-Attendance-system\Images_GUI\tra1.jpg")
        ...
        # Photo   button 6
        pho_img_btn=Image.open(r"D:\program\python language\Smart-Ai-Attendance-system\Images_GUI\qr1.png")
        ...
        # Developers   button 7
        dev_img_btn=Image.open(r"D:\program\python language\Smart-Ai-Attendance-system\Images_GUI\dev.jpg")
        ...
        # exit   button 8
        exi_img_btn=Image.open(r"D:\program\python language\Smart-Ai-Attendance-system\Images_GUI\exi.jpg")
...
# ==================Funtion for Open Images Folder==================
    def open_img(self):
        os.startfile("D:/program/python language/Python-FYP-Face-Recognition-Attendence-System-master/data_img")
# ==================Functions Buttons=====================
